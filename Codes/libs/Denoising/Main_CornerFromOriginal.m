...
[corner_index,corner_index3,corner_index4,marked_img,marked_img3,marked_img4,edge_map]=...
    curvature_corner_frame2(gsimg,C,T_angle,sig,H,L,Endpoint,Gap_size,Open_size);
%     corners=detectFASTFeatures(gsimg(:,:,i),'MinContrast',0.01);
...
[corner_index,corner_index3,corner_index4,marked_img,marked_img3,marked_img4,edge_map]...
    =curvature_corner_frame2(deimg,C,T_angle,sig,H,L,Endpoint,Gap_size,Open_size);
