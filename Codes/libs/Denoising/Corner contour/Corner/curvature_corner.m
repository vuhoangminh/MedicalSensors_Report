function [corner_index,marked_img,edge_map]=curvature_corner(varargin)
...
%tic
corner_index=get_corner(curve,curve_start,curve_end,curve_mode,curve_num,BW,sig,Endpoint,C,T_angle); % Detect corners
...
function corner_index=get_corner(curve,curve_start,curve_end,curve_mode,curve_num,BW,sig,Endpoint,C,T_angle)
