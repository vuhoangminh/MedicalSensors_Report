classdef InverseBlockDct2d < matlab.System %#codegen
    %INVERSEBLOCKDCT2D 2-D inverse block discrete cosine transform class
    %
    % SVN identifier:
    % $Id: InverseBlockDct2d.m 348 2012-10-31 06:10:34Z harashin $
    %
...
%         blcRow = zeros(4,1);
    ...
    methods
        function obj = InverseBlockDct2d()
%             obj.e0 = [
...
%                         reshape(flipud(obj.e0.'*obj.blcRow),2,2);
