classdef CoefShiftFixd < matlab.System %#codegen
    %COEFSHIFTFIXD CoefficientShift class for fixed-point arithmetic
    %
    % SVN identifier:
    % $Id: CoefShiftFixd.m 348 2012-10-31 06:10:34Z harashin $
    %
    ...
    methods
        function obj = CoefficientShiftFixd(varargin)
    ...
    methods (Access = protected)
        function value = stepImpl(obj,src)
            ...
            value = fi(zeros(nRows,nCols),1,20,6);
