...
%
% WARNING: this function uses mdwt(), midwt() functions
%          in the Rice Wavelet Matlab Toolbox
%          Installation of Rice Wavelet Toolbox recommened.
%          Or, you need to have mdwt() and midwt() routines
%          that produce 2-D DWT in the same format.
%          (See README file included in the package)
%
% input:
%   x : noisy image
