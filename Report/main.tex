...
\input{section-contourlet}
\input{section-imagedenoising}
\input{section-imagesegmentation}


%Chapter 3 - implementation
\input{chapter-3}
\input{section-imp_codingstandard}
\input{section-imp_denoising}
\input{section-imp_segmentation}
\input{section-imp_gui}
